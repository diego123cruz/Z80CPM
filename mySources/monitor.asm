...
;------------------------------------------------------------------------------
; Serial port B config (default 9600)
;------------------------------------------------------------------------------
SERIAL
		LD   HL,STR_S	; Print SERIAL OPTIONS message
		CALL PRINT
		LD   A,'>'	; Get a ">"	
		RST 08H		; print it

S_LOOP		CALL RDCHR	; Get a character from the input port
		CP   ' '	; <spc> or less? 	
		JR   C,S_LOOP	; Go back
...
SIGNON	.BYTE	"Z80 SBC Boot ROM 1.1"
		...
		.BYTE	$0D,$0A
		.BYTE	$0D,$0A
		.BYTE	"Serial B = 9600 (default)"
		.BYTE	$0D,$0A
		.BYTE	"GFFE8 - Move 4100h to"
		.BYTE	" 100h and start CP/M"
		.BYTE	$0D,$0A
		.BYTE	$0D,$0A
...
STR_S	.BYTE	$0D,$0A
		.BYTE	$0D,$0A
		.BYTE	"Serial Port B  config"
		.BYTE	" (default 9600)"
		.BYTE	$0D,$0A
		.BYTE	"Press 0-9 to config"
		.BYTE	$0D,$0A
		.BYTE	$0D,$0A
		.BYTE	"0 - 57600"
		.BYTE	$0D,$0A
